...
```bash
npm install @stdlib/random-streams-triangular
```
...
```bash
npm install -g @stdlib/random-streams-triangular
```
...
[test-image]: https://github.com/stdlib-js/random-streams-triangular/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/random-streams-triangular/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-triangular
